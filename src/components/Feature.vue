<template>
    <section id="feature" class="w-full relative bg-accent-blue py-12">
        <div class="row w-9/12 mx-auto flex items-center justify-between">
            <div class="w-2/5">
        ...
        <div class="w-2/5">
            ...
            <h3 class="text-dark-green text-3xl font-bold mb-2">Customizable dashboard for all plaforms.</h3>
            <p class="text-grey-200 text-sm mb-3">Use Twitter and Instagram but not linkedin? You can customize your dashboard to your liking. You can even schedule the same post to individual platforms instead of all platforms.</p>
            <a href="#" class="inline-flex items-center py-4 text-base font-semibold text-grey-200">View Live demo <i class='bx bx-right-arrow-alt ml-1' ></i></a>
        </div>
        </div>
    </section>
</template>
